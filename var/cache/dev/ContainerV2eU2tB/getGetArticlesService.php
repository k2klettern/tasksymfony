...
// Returns the private 'App\Repository\GetArticles' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/GetArticles.php';

return $this->privates['App\Repository\GetArticles'] = new \App\Repository\GetArticles(($this->services['doctrine'] ?? $this->getDoctrineService()));
