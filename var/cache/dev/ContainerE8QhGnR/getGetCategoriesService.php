...
// Returns the private 'App\Repository\GetCategories' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/GetCategories.php';

return $this->privates['App\Repository\GetCategories'] = new \App\Repository\GetCategories(($this->services['doctrine'] ?? $this->getDoctrineService()));
