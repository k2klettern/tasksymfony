...
// Returns the private 'App\Repository\GetArtcatrelations' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/GetArtcatrelations.php';

return $this->privates['App\Repository\GetArtcatrelations'] = new \App\Repository\GetArtcatrelations(($this->services['doctrine'] ?? $this->getDoctrineService()));
