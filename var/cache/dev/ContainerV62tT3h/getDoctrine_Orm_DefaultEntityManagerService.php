...
$b->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\GetArtcatrelations' => function () {
    return ($this->privates['App\Repository\GetArtcatrelations'] ?? $this->load('getGetArtcatrelationsService.php'));
}, 'App\\Repository\\GetArticles' => function () {
    return ($this->privates['App\Repository\GetArticles'] ?? $this->load('getGetArticlesService.php'));
}, 'App\\Repository\\GetCategories' => function () {
    return ($this->privates['App\Repository\GetCategories'] ?? $this->load('getGetCategoriesService.php'));
